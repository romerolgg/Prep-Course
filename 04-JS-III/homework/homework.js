...
const { tienenMismaLongitud } = require("../../02-JS-I/homework/homework");
...
// Utiicé ".join" que une las strings con un parámetro que nosotros le designemos 
...
//suma = suma + numeros[i]}
//return suma
   let suma = numeros.reduce((actual, nuevo) => actual + nuevo, 0)
   return suma
}
